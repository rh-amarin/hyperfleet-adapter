...
go run ./cmd/adapter/main.go serve \
  ...
  --task-config ./test/testdata/dryrun/maestro/dryrun-maestro-adapter-task-config.yaml \
  --dry-run-event ./test/testdata/dryrun/event.json \
  --dry-run-discovery ./test/testdata/dryrun/maestro/dryrun-maestro-discovery.json \
